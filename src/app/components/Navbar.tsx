...
const navLinks = [
  ...
  { id: "cuaca", label: "Prediksi Cuaca" },
  { id: "rute", label: "Rute Aman" },
  { id: "asisten", label: "DITA AI" },
  { id: "itinerary", label: "Smart Itinerary" },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <button onClick={() => scrollTo("beranda")} className="flex items-center gap-2.5 group flex-shrink-0">
            ...
            <div className="text-left">
              <div className="text-white font-bold text-base leading-tight">SmartDieng</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden md:block px-4 py-2 rounded-full text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105"
              style={{
