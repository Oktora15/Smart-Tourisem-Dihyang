...
export default function ChatbotSection() {
  ...
  const sendMessage = (text: string) => {
    ...
    setTimeout(() => {
      const response =
        botResponses[text] ||
        "Maaf, saya belum punya info spesifik tentang itu. Coba tanyakan tentang cuaca Dieng, tiket wisata, penginapan, transportasi, atau spot foto terbaik di Dieng! 🏔️";
      setIsTyping(false);
