...
const botResponses: Record<string, string> = {
  "Bagaimana cuaca di Dieng hari ini?":
    "🌡️ **Cuaca Dieng Hari Ini:**\n\n• **Suhu sekarang:** 13°C (terasa seperti 10°C)\n• **Kondisi:** Berkabut di pagi hari, cerah siang hari\n• **Malam nanti:** 7°C — sangat dingin!\n\n⚠️ **Tips:** Bawa jaket tebal, sarung tangan, dan syal. Dieng bisa turun hingga **0°C** di Juli–Agustus (embun upas/es).\n\nSaran aktivitas hari ini: ✅ Sunrise Bukit Sikunir, ✅ Kawah Sikidang, ✅ Telaga Warna",
  "Apa saja tempat wisata terbaik di Dieng?":
    "🏔️ **Wisata Terbaik Dieng:**\n\n1. **🌄 Bukit Sikunir** — Sunrise spektakuler, terbaik di Dieng!\n2. **🏛️ Kompleks Candi Arjuna** — Warisan Hindu abad ke-7\n3. **🌊 Telaga Warna** — Danau vulkanik yang berubah warna\n4. **🔥 Kawah Sikidang** — Kawah aktif yang bisa diakses\n5. **🗿 Batu Ratapan Angin** — View point terbaik untuk foto\n6. **⛲ Sumur Jalatunda** — Sumur misterius warisan leluhur\n7. **🏛️ Museum Kailasa** — Artefak peradaban Dieng\n8. **⛰️ Gunung Prau** — Trekking dengan pemandangan pagi memukau",
  "Berapa harga tiket Candi Arjuna?":
    "🎟️ **Tiket Masuk Kawasan Dieng:**\n\n🏛️ **Kompleks Candi Arjuna:**\n• Wisatawan Lokal: **Rp 20.000**\n• Wisatawan Asing: **Rp 50.000**\n\n🌊 **Telaga Warna:** Rp 20.000\n🔥 **Kawah Sikidang:** Rp 15.000\n🌄 **Bukit Sikunir:** Rp 10.000\n🏛️ **Museum Kailasa:** Rp 10.000\n\n💡 **Tips:** Ada paket terusan semua destinasi dengan harga lebih hemat. Tanyakan di loket utama Dieng Plateau!",
  "Di mana spot sunrise terbaik di Dieng?":
    "🌄 **Sunrise Terbaik di Dieng:**\n\n1. **Bukit Sikunir** ⭐⭐⭐⭐⭐\n   • Start pendakian: **03.30–04.00**\n   • Durasi: ~45 menit ke puncak\n   • Tiket: Rp 10.000\n   • View: Golden Sunrise + Gunung Sindoro, Sumbing, Prau\n\n2. **Gunung Prau** ⭐⭐⭐⭐⭐\n   • Trekking 2–3 jam\n   • Camping recommended\n\n3. **Batu Ratapan Angin** ⭐⭐⭐⭐\n   • Lebih mudah dicapai\n   • Gratis akses\n\n⚠️ **Cuaca:** Cek prakiraan malam sebelumnya. Berkabut tebal = sunrise tertutup.",
  "Rekomendasikan penginapan di Dieng":
    "🏨 **Penginapan di Dieng & Wonosobo:**\n\n🌟 **Dieng (dekat wisata):**\n• Homestay Bu Jono: Rp 100–150rb/malam\n• Penginapan Dieng Resto: Rp 150rb/malam\n• Villa Dieng Permai: Rp 300–500rb/malam\n\n🏙️ **Wonosobo (kota, lebih nyaman):**\n• Hotel Kresna: Rp 350rb/malam ⭐4.2\n• Dian Hotel: Rp 250rb/malam ⭐4.0\n• Surya Asia Hotel: Rp 200rb/malam\n\n💡 **Tips:** Menginap di Dieng = lebih dekat ke Bukit Sikunir untuk sunrise. Bawa sleeping bag ekstra — sangat dingin malam hari!",
  "Bagaimana cara ke Dieng dari Yogyakarta?":
    "🚌 **Rute Yogyakarta → Dieng:**\n\n**Opsi 1 — Bus + Elf (Murah):**\n🚌 Jogja → Wonosobo (bus Efisiensi): Rp 45.000 | 3,5 jam\n🚐 Wonosobo → Dieng (angkot/elf): Rp 15.000 | 1 jam\n⏱️ Total: ~5 jam | 💰 Rp 60.000\n\n**Opsi 2 — Travel Shuttle:**\n🚐 Jogja langsung ke Dieng: Rp 120.000 | 4 jam\nTersedia via platform Traveloka, RedBus\n\n**Opsi 3 — Sewa Mobil:**\n🚗 Rp 400.000–600.000/hari (dengan driver)\nFleksibel & nyaman untuk keluarga\n\n📍 **Jarak:** Jogja–Dieng ±120 km via jalur Magelang atau Wonosobo",
};
...
export default function FloatingChatbot() {
  ...
  const sendMessage = (text: string) => {
    ...
    setTimeout(() => {
      const response =
        botResponses[text] ||
        "Maaf, saya belum memiliki info spesifik tentang itu. Coba tanyakan tentang cuaca Dieng, tiket wisata, penginapan, transportasi, atau spot foto terbaik. Saya siap membantu! 🏔️";
      setIsTyping(false);
      setMessages((prev) => [...prev, { id: Date.now(), role: "bot", text: response, time: nowTime() }]);
    }, 1400);
  };
